...
public:
    MyFrame() : wxFrame(nullptr, wxID_ANY, "YYCookies", wxDefaultPosition, wxSize(640, 480)) {
        ...
        CreateStatusBar();
        SetStatusText("Welcome to YYCookies");

        auto* panel = new wxPanel(this);
        auto* mainSizer = new wxBoxSizer(wxVERTICAL);

        auto* title = new wxStaticText(panel, wxID_ANY, "YYCookies", wxDefaultPosition, wxDefaultSize, wxALIGN_CENTER);
